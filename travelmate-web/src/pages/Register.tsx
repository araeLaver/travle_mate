...
const Register: React.FC = () => {
  ...
  const handleOAuthSuccess = useCallback(async (provider: 'google' | 'kakao' | 'naver', accessToken: string) => {
    setError('');
    try {
            ...
            <div className="mt-4 space-y-3">
              ...
              >
                {oauthLoading === 'kakao' ? (
                  ...
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="#3C1E1E" d="M12 3c-5.52 0-10 3.59-10 8 0 2.87 1.89 5.39 4.74 6.82-.21.78-.77 2.83-.88 3.27-.14.54.2.53.42.39.17-.11 2.74-1.86 3.85-2.62.62.09 1.25.14 1.87.14 5.52 0 10-3.59 10-8s-4.48-8-10-8z" />
                  </svg>
                )}
                카카오로 시작하기
              </button>
              {NAVER_CLIENT_ID && (
                ...
                >
                  {oauthLoading === 'naver' ? (
                    ...
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path fill="white" d="M16.273 12.845L7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727z" transform="scale(0.8) translate(3, 3)" />
                    </svg>
                  )}
                  네이버로 시작하기
                </button>
