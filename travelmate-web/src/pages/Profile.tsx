          ...
          <div className="preferences-tab">
            ...
            <div className="pref-section">
              ...
              <div className="pref-tags">
                {profile.preferences.accommodationType.map((type, index) => (
                  <span key={index} className="pref-tag">{type}</span>
                ))}
              </div>
            </div>
            ...
            <div className="pref-section">
              ...
              <div className="pref-tags">
                {profile.preferences.transportPreference.map((transport, index) => (
                  <span key={index} className="pref-tag">{transport}</span>
                ))}
              </div>
            </div>
            ...
            <div className="pref-section">
              ...
              <p>
                ...
                활동 레벨: <span className="pref-value">{profile.preferences.activityLevel}</span>
              </p>
            </div>
          </div>
        )}
